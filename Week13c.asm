...
space       DB ' $'
header DB 'Filename: Week13c.asm', 0Ah, \
   'Programmer Name: Christian A. Nemeno', 0Ah, \
   'Program Description: Ask user to input a number from 1 to 8. Display error message if number entered is less than 1 or greater than 8. If input is correct, horizontally display the numbers, with space between each number, from 1 to the number entered by user.', 0Ah, \

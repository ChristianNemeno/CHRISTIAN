...
.data
    ...
    borrow_book_title       db 13,10,10,10,10,'                                   Rent Car',13,10,0
    borrow_bookID_prompt    db 13,10,10,'   Enter Car no. to Rent:',0
    borrow_bookdays_prompt  db 13,10,'   Enter the number of days until due to return:',0

    update_book_title       db 13,10,10,10,10,'                            CHANGE DAYS TILL RETURN',13,10,0
    update_bookID_prompt    db 13,10,10,'   Enter Car no. to Update:',0
    ...
    book_list_menu db 13,10,10,'                                    Cars parked       ',13,10,0
    ...
    book_list_row_01         db '          ',179,' 01.) Toyota                   ',179,'    0    ',179,'',0
    book_list_row_02         db '          ',179,' 02.) Ferrari                  ',179,'    1    ',179,'',0
    book_list_row_03         db '          ',179,' 03.) Mini Van                 ',179,'    2    ',179,'',0
    book_list_row_04         db '          ',179,' 04.) Ford                     ',179,'    3    ',179,'',0
    book_list_row_05         db '          ',179,' 05.) Audi                     ',179,'    4    ',179,'',0
    book_list_row_06         db '          ',179,' 06.) Pick up                  ',179,'    5    ',179,'',0
    book_list_row_07         db '          ',179,' 07.) Fortuner                 ',179,'    6    ',179,'',0
    book_list_row_08         db '          ',179,' 08.) Lamborghini              ',179,'    7    ',179,'',0
    book_list_row_09         db '          ',179,' 09.) Bentley                  ',179,'    8    ',179,'',0
    book_list_row_10         db '          ',179,' 10.) Mercedes                 ',179,'    9    ',179,'',0
    book_list_row_end        db '          ',192,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,193,196,196,196,196,196,196,196,196,196,193,196,196,196,196,196,196,196,196,196,196,196,196,196,196,217,13,10,0
    available db '   Available  ',179,'','$'
    borrowed db  '   Unavailable',179,'','$'

    book_list_borrowed_menu db 13,10,10,'                                Rented Cars',13,10,0
    
    book_name_01 db '   Toyota            ',0,'$'
    book_name_02 db '   Ferrari           ',0,'$'
    book_name_03 db '   Mini Van          ',0,'$'
    book_name_04 db '   Ford              ',0,'$'
    book_name_05 db '   Audi              ',0,'$'
    book_name_06 db '   Pick up           ',0,'$'
    book_name_07 db '   Fortuner          ',0,'$'
    book_name_08 db '   Lamborghini       ',0,'$'
    book_name_09 db '   Bentley           ',0,'$'
    book_name_10 db '   Mercedes          ',0,'$'

    dash db ' -',0,'$'
    days_left db ' day/s until due to return',0,'$'

    dash_book_id db '  -  Car number:',0,'$'
    ...
    book_not_borrowed  db '   You cant rent this car!',0,'$'

...
.data
  ...
  outList1 db 0ah,'   Item No. 1:    | $'
  outList2 db 0ah,'   Item No. 2:    | $'
  outList3 db 0ah,'   Item No. 3:    | $'
  outList4 db 0ah,'   Item No. 4:    | $'
  outList5 db 0ah,'   Item No. 5:    | $'
